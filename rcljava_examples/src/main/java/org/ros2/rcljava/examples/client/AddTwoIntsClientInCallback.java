...
public class AddTwoIntsClientInCallback {

  private static Client<example_interfaces.srv.AddTwoInts> client;
  ...
  public static void main(final String[] args) throws InterruptedException, Exception {
    ...
    client = node.<example_interfaces.srv.AddTwoInts>createClient(
    ...
    Subscription<std_msgs.msg.String> subscription = node.<std_msgs.msg.String>createSubscription(
      std_msgs.msg.String.class, "topic", AddTwoIntsClientInCallback::topicCallback);

    // SingleThreadedExecutor does not work
    // RCLJava.spin(node);
